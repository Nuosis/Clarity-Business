        ...
        <Layout>
            ...
            {connectionRequestModal &&
                <>
                            ...
                            <div className='my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto cus-scrollbar'>
                                ...
                                <ul className="flex flex-col md:gap-8 gap-6 mt-6">
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <Image src={avatar1} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                    ...
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <Image src={avatar2} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                        <div className='flex-grow'>
                                    ...
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <Image src={avatar3} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                        <div className='flex-grow'>
                                    ...
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <Image src={avatar4} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                        <div className='flex-grow'>
                    ...
                    <div onClick={ConnectionRequestModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
            {createEventModal &&
                <>
            ...
            {orderTrackingModal &&
                <>
                        ...
                        <div className='py-10 md:px-10 px-[7px] bg-card-color rounded-lg shadow-shadow-lg'>
                            <div className='my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto cus-scrollbar'>
                                ...
                                <div className="bg-body-color md:p-4 p-2 mb-2 rounded-xl">
                                    ...
                                    <p>Swift Pro <span className="font-bold"><Link href="#" className='text-primary transition-all hover:text-secondary'>V504KO</Link></span></p>
                                </div>
                    ...
                    <div onClick={openOrderTrackingModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
        </Layout>
    )
