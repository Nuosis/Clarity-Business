...
export default function Chat() {
    ...
    return (
        <Layout>
            <div className='flex'>
                <div className={`bg-card-color sm:min-w-[320px] sm:w-[320px] min-w-[280px] w-[280px] lg:static fixed z-[2] rounded-ss-2xl transition-all duration-300 ${chatSide ? 'md:left-[13px] sm:left-2 left-0 rtl:md:right-[13px] rtl:sm:right-2 rtl:right-0 shadow-shadow-lg' : '-left-full rtl:-right-full'}`}>
                    ...
                    <div>
                        <Tabs>
                            ...
                            <div className='xl:h-[calc(100svh-77px-52px-75px)] md:h-[calc(100svh-73px-52px-75px)] h-[calc(100svh-60px-52px-75px)] overflow-auto no-scrollbar'>
                                <TabPanel>
                                    <ul>
                                        ...
                                        <li className='border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color'>
                                            <span className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary'>
                                                RH
                                            </span>
                                            <div className='truncate w-full'>
                                                <div className='flex items-center gap-2 justify-between'>
                                ...
                                <TabPanel>
                                    ...
                                    <li className='border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color'>
                                        ...
                                        <div className='truncate w-full'>
                                            ...
                                            <p className='text-[14px]/[20px] text-font-color-100 truncate'>
                                                barbara.kelly@SWIFT.com
                                            </p>
                                        </div>
                                    </li>
                                    <li className='border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color'>
                                        <Image src={avatar10} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                                        <div className='truncate w-full'>
                                            <div className='flex items-center gap-2 justify-between'>
                                                <p className='truncate'>
                                                    Richard Foos
                ...
                <div className='flex-1'>
                    <div className='border-b border-dashed border-border-color py-4 xxl:px-12 px-4 flex items-center gap-2 justify-between'>
                        ...
                        <div className='flex gap-2 items-center'>
                            ...
                            <button className='lg:hidden bg-primary-10 p-[2px] rounded text-primary transition-all hover:bg-primary hover:text-white'>
                    ...
                    <ul className='py-4 xxl:px-12 px-4 flex flex-col gap-4 xl:h-[calc(100svh-77px-77px-69px)] md:h-[calc(100svh-73px-77px-69px)] h-[calc(100svh-60px-77px-69px)] overflow-auto no-scrollbar'>
            ...
            {chatVideoModal &&
                <>
                    ...
                    <div onClick={openChatVideoModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
        </Layout>
    )
