...
import MyDrive from '@/components/pages/app/fileManager/MyDrive'
import SharedWithMe from '@/components/pages/app/fileManager/SharedWithMe'
import Recent from '@/components/pages/app/fileManager/Recent'
import Trash from '@/components/pages/app/fileManager/Trash'
...
export default function AppFileManager() {
    ...
    return (
        <Layout>
            <Tabs className='flex'>
                <div className={`bg-card-color min-w-[230px] w-[230px] p-4 xl:h-[calc(100svh-77px)] md:h-[calc(100svh-73px)] h-[calc(100svh-60px)] overflow-auto no-scrollbar lg:static fixed rounded-tl-2xl transition-all duration-300 ${fileManagerSide ? 'z-[2] md:left-[13px] sm:left-2 left-0 shadow-shadow-lg' : '-left-full'}`}>
                    ...
                    <button onClick={toggleAnalytics} className={`flex items-center gap-4 font-semibold py-2 cursor-pointer transition-all duration-300 hover:text-primary after:fixed after:z-[4] after:w-full after:h-full after:left-0 after:top-0 after:bg-black-50 after:backdrop-blur-[2px] after:transition-all after:duration-500 after:ease-in-out ${analyticsSidebar ? 'after:opacity-1 after:visible after:overflow-auto' : 'after:opacity-0 after:invisible after:overflow-hidden'}`}>
            ...
            <div className={`fixed top-0 bg-card-color z-[5] h-svh w-full max-w-[400px] transition-all duration-200 ${analyticsSidebar ? 'ltr:right-0 rtl:left-0' : 'ltr:-right-full rtl:-left-full'}`}>
                ...
                <div className='md:p-6 p-4 md:h-[calc(100svh-63px)] h-[calc(100svh-55px)] overflow-auto no-scrollbar'>
                    <div className='flex flex-col gap-4'>
                        <div className='md:p-6 p-4 rounded-xl card bg-body-color'>
