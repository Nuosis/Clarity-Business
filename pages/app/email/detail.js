        ...
        <Layout>
            <div className='flex'>
                ...
                <div className='flex-1 md:p-6 p-4 xl:h-[calc(100svh-77px)] lg:h-[calc(100svh-73px)] overflow-auto no-scrollbar'>
                    ...
                    <div className='card bg-card-color rounded-xl border border-transparent overflow-hidden'>
                        ...
                        <div className='py-4 md:px-6 px-4 bg-body-color flex gap-4'>
                            <Image src={avatar1} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md mt-2' />
                        ...
                        <div className='md:p-6 p-4'>
                            <div className='pb-4 mb-4 border-b border-border-color '>
                                ...
                                <br />
                                <p className='mb-4'>Swift Pro</p>
                                <div>Skype : swiftpro</div>
                                <div>Website: swiftpro.com</div>
                            </div>
