...
import EmailSidebar from '@/components/pages/app/email/EmailSidebar'
                            ...
                            <div className='flex items-start gap-4'>
                                ...
                                <div className='grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1'>
                                    ...
                                    <div className=''>
                                        ...
                                        <button className='mt-2 flex items-center gap-2 text-[14px]/[1] text-danger py-1 px-4 border border-border-color rounded-full'>
                                ...
                                <div className='grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1'>
                                    ...
                                    <div className=''>
                                        ...
                                        <div className='mt-2 flex items-stretch gap-4'>
                                            <button className='flex items-center gap-2 text-[14px]/[1] text-success py-1 px-4 border border-border-color rounded-full'>
                                                established.exc
                                            </button>
                                            <button className='flex items-center gap-2 text-[14px]/[1] text-danger py-1 px-4 border border-border-color rounded-full'>
                                                <IconFileTypePdf className='w-[20px] h-[20px] stroke-[1.5]' />
                                                established.pdf
                                            </button>
                                        </div>
                            ...
                            <div className='flex items-start gap-4'>
                                ...
                                <div className='grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1'>
                                    ...
                                    <div className=''>
                                        ...
                                        <button className='mt-2 flex items-center gap-2 text-[14px]/[1] text-primary py-1 px-4 border border-border-color rounded-full'>
                            ...
                            <div className='flex items-start gap-4'>
                                ...
                                <div className='grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1'>
                                    ...
                                    <div className=''>
                                        ...
                                        <button className='mt-2 flex items-center gap-2 text-[14px]/[1] text-info py-1 px-4 border border-border-color rounded-full'>
