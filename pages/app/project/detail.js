...
import Overview from '@/components/pages/app/project/projectDetail/Overview'
import User from '@/components/pages/app/project/projectDetail/User'
import File from '@/components/pages/app/project/projectDetail/File'
import Activity from '@/components/pages/app/project/projectDetail/Activity'
import Setting from '@/components/pages/app/project/projectDetail/Setting'
        ...
        <Layout>
            <Tabs className='flex'>
                <div className={`bg-card-color min-w-[230px] w-[230px] p-4 xl:h-[calc(100svh-77px)] md:h-[calc(100svh-73px)] h-[calc(100svh-60px)] overflow-auto no-scrollbar lg:static fixed rounded-tl-2xl transition-all duration-300 ${projectSide ? 'z-[2] md:left-[13px] sm:left-2 left-0 shadow-shadow-lg' : '-left-full'}`}>
                    ...
                    <Image src={avatar1} width="90" height="90" alt='user' className='p-1 border border-border-color rounded-md mb-4' />
