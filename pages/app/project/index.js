...
import AllProject from '@/components/pages/app/project/projectList/AllProject'
import InProgress from '@/components/pages/app/project/projectList/InProgress'
import UpComing from '@/components/pages/app/project/projectList/UpComing'
import Overdue from '@/components/pages/app/project/projectList/Overdue'
import Completed from '@/components/pages/app/project/projectList/Completed'
import Image from 'next/image'
import NewProject from '@/components/pages/app/project/NewProject'
...
export default function ProjectList() {
    ...
    return (
        <Layout>
            <Tabs className='flex'>
                <div className={`bg-card-color min-w-[230px] w-[230px] p-4 xl:h-[calc(100svh-77px)] md:h-[calc(100svh-73px)] h-[calc(100svh-60px)] overflow-auto no-scrollbar lg:static fixed rounded-tl-2xl transition-all duration-300 ${projectSide ? 'z-[2] md:left-[13px] sm:left-2 left-0 shadow-shadow-lg' : '-left-full'}`}>
                    ...
                    <ul className='flex flex-wrap gap-3'>
                        <li>
                            <Image src={avatar1} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                        </li>
                        <li>
                            <Image src={avatar2} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                        </li>
                        <li>
                            <Image src={avatar3} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                        </li>
                        <li>
                            <Image src={avatar4} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                        </li>
                        <li>
                            <Image src={avatar5} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                        </li>
                    </ul>
                </div>
