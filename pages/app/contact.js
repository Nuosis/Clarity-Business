...
import MyContact from '@/components/pages/app/contact/MyContact';
import MyGroup from '@/components/pages/app/contact/MyGroup';
import Favourite from '@/components/pages/app/contact/Favourite';
import MergeFix from '@/components/pages/app/contact/MergeFix';
import Trash from '@/components/pages/app/contact/Trash';
        ...
        <Layout>
            ...
            {addContactModal &&
                <>
                    ...
                    <div onClick={openAddContactModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
        </Layout>
    );
