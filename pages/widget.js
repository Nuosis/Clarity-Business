        ...
        <Layout>
            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-4'>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='md:p-6 p-4 rounded-xl card bg-card-color'>
                    ...
                    <div className='flex gap-4 sm:flex-row flex-col-reverse card bg-secondary text-white rounded-xl overflow-hidden md:p-6 p-4'>
                        <div>
                        ...
                        <Image src={campaigns_new} alt='campaigns_new' width="164" height="142" className='sm:ms-auto' />
                    </div>
                </div>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='card bg-card-color rounded-xl overflow-hidden'>
                    ...
                    <div className='card bg-card-color rounded-xl p-4 relative'>
                        <div className='bg-primary p-5 w-[30px] inline-flex items-center justify-center absolute top-0 end-[20px] after:absolute after:end-0 after:top-[calc(100%-10px)] after:border-[15px] after:border-primary after:border-b-[5px] after:border-b-transparent '>
                    ...
                    <div className='card bg-card-color md:p-6 p-4 rounded-xl flex flex-col items-center'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='card bg-card-color rounded-xl'>
                        <div className='md:p-6 p-4 border-b border-dashed border-border-color'>
                            <h5 className='text-[20px]/[26px] font-medium mb-1'>
                                <Link href="/app-project-detail" className='transition-all hover:text-secondary'>
                                    School / University
                                </Link>
                            </h5>
                    ...
                    <div className='card overflow-hidden bg-card-color rounded-xl relative'>
                    ...
                    <div className='card bg-card-color rounded-xl md:p-6 p-4 flex md:gap-4 gap-2 items-center'>
                    ...
                    <div className='card bg-card-color rounded-xl overflow-hidden md:mb-8 mb-6'>
                        <div className='md:p-6 p-4 bg-secondary text-white'>
                            <h4 className='text-[24px]/[30px] font-medium mb-2'>swiftpro.com</h4>
            ...
            {jobListingModal &&
                <>
                    ...
                    <div onClick={openJobListingModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
            {campaignsModal &&
                <>
                    ...
                    <div onClick={openCampaignsModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
        </Layout>
    )
