                    ...
                    <div className='flex items-start gap-15'>
                        ...
                        <div className=''>
                            ...
                            <ul className='list-disc pl-15 mt-5 flex flex-col gap-5'>
                                <li>
                                    Initial release of SWIFT! Lots more coming soon, though. 😁
                                </li>
                                <li>
                                    ...
                                    <ul className='pl-15 mt-5 flex flex-col gap-5'>
                                        <li>
                                            - Next JS <span className='inline-block bg-bg-light-100 text-success rounded-full py-1 px-2 text-[12px]/[1]'>v14.2.5</span>
                                        </li>
                                        <li>
