...
export default function Bookmark() {
    ...
    return (
        <Layout>
            ...
            <Tabs>
                <div className='card bg-card-color rounded-xl grid xxl:grid-cols-[1fr_3fr] lg:grid-cols-[1.5fr_3fr] grid-cols-1'>
                    <TabList className="lg:border-r lg:border-b-0 border-b border-border-color">
                        <div className='md:p-6 p-4 border-b border-border-color'>
                            <Image src={profile_av} width="90" height="90" alt="user profile" className="w-[90px] h-[90px] min-w-[90px] p-1 border border-border-color rounded-md" />
                    ...
                    <div className='md:p-6 p-4'>
                        <TabPanel>
                            ...
                            <ul>
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    ...
                                    <button className='bg-primary-10 p-[2px] rounded text-primary self-start md:order-3 order-2 transition-all hover:bg-primary hover:text-white'>
            ...
            {createBookmarkModal &&
                <>
                    ...
                    <div onClick={openCreateBookmarkModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
        </Layout>
    )
