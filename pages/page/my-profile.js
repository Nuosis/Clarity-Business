...
import Overview from '@/components/pages/page/myProfile/Overview';
import Group from '@/components/pages/page/myProfile/Group';
import Project from '@/components/pages/page/myProfile/Project';
import Campaign from '@/components/pages/page/myProfile/Campaign';
import Activity from '@/components/pages/page/myProfile/Activity';
                    ...
                    <div className='md:p-6 p-4 border-b border-border-color'>
                        <div className='flex md:items-start items-center md:gap-12 gap-4 md:flex-row flex-col'>
                            ...
                            <div className='md:text-start text-center'>
                                ...
                                <div className='flex md:gap-x-12 gap-x-6 gap-y-3 flex-wrap md:justify-start justify-center'>
                                    <div>
                ...
                <div className='md:p-6 p-4 md:h-[calc(100svh-63px)] h-[calc(100svh-55px)] overflow-auto no-scrollbar'>
                    <div className='form grid grid-cols-12 md:gap-6 gap-4'>
                        ...
                        <div className="form-control sm:col-span-6 col-span-12">
                            ...
                            <input type="text" id="editProfileEmail" className="form-input" placeholder="alliegrater@swift.com" />
                        </div>
                        <div className="form-control sm:col-span-6 col-span-12">
