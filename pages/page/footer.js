    ...
    return (
        <Layout>
            ...
            <div className='flex flex-col gap-6'>
                <Footer className="p-6 bg-card-color rounded-xl" />
                <div className="footer p-6 bg-card-color rounded-xl flex items-center justify-between gap-15 md:flex-row flex-col md:text-[16px]/[24px] text-[14px]/[20px]">
                    <div className='flex items-center gap-4 md:flex-row flex-col'>
                        ...
                        <p className='text-font-color-100 text-center'>
                            © {CurrentYear} <Link href="/" className='text-primary'>Swift Pro</Link>, All Rights Reserved.
                        </p>
                    </div>
                ...
                <div className="footer p-6 bg-card-color rounded-xl flex items-center justify-between gap-15 flex-col md:text-[16px]/[24px] text-[14px]/[20px]">
                ...
                <div className="footer p-6 bg-card-color rounded-xl grid lg:grid-cols-[1fr_1.5fr] grid-cols-1 gap-6 md:text-[16px]/[24px] text-[14px]/[20px]">
                    <div>
                        ...
                        <p className='text-font-color-100 flex items-center gap-1 flex-wrap'>
                            © {CurrentYear} <Link href="/" className='text-primary'>Swift.</Link><IconHeartFilled className='w-[20px] h-[20px] min-w-[20px] text-danger' /> by <span className='text-danger'>Swift Pro</span>.
                        </p>
                    </div>
                ...
                <div className="footer p-6 bg-card-color rounded-xl md:text-[16px]/[24px] text-[14px]/[20px]">
