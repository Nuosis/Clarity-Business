    ...
    return (
        <Layout>
            ...
            <Tabs>
                <div className='card bg-card-color rounded-xl'>
                    ...
                    <TabList className="flex flex-wrap md:px-6 px-4 pt-2 gap-y-2 relative justify-start border-t border-border-color">
                        ...
                        <div className='relative group'>
                            ...
                            <div className='bg-card-color text-font-color rounded-xl overflow-auto max-h-[50svh] no-scrollbar w-[200px] shadow-shadow-lg absolute right-0 top-full origin-top-right z-[1] opacity-0 invisible scale-0 transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:scale-100'>
                            <ul>
                ...
                <div className='card my-6 md:p-6 p-4 bg-card-color rounded-xl'>
                    <TabPanel>
                        <ul>
                            <li className='md:pb-6 pb-4 md:mb-6 mb-4 border-b border-border-color last:mb-0'>
                                <p className='mb-1'>
                                    https://alui.swift-edu.com/index.html
                                </p>
                                <Link href="#" className='mb-2 inline-block md:text-[20px]/[24px] text-[18px]/[22px] font-light text-primary transition-all hover:text-secondary'>
                                    SWIFT - Bootstrap 5 Responsive Admin Dashboard Theme
                                </Link>
                                <p className='text-font-color-100 mb-4'>
                                    Boost your project with powerful SWIFT admin dashboard template that is tailored to fit every company's needs.
                                </p>
                            ...
                            <li className='md:pb-6 pb-4 md:mb-6 mb-4 border-b border-border-color last:mb-0'>
                                <p className='mb-1'>
                                    https://swift-edu.info/
                                </p>
                                <Link href="#" className='mb-2 inline-block md:text-[20px]/[24px] text-[18px]/[22px] font-light text-primary transition-all hover:text-secondary'>
                                    Lucid ASP .NET Core MVC - Responsive Admin Template
                                </Link>
                                <p className='text-font-color-100 mb-4'>
                                    SWIFT introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching, GMAT Coaching, SAT Coaching in City.
                                </p>
                                <div className='flex items-center flex-wrap md:gap-x-6 gap-x-4 text-font-color-100'>
                                    <div className='flex items-center gap-1'>
                                        <IconStarFilled className='w-[16px] h-[16px] fill-warning' />
                    ...
                    <TabPanel>
                        <SlideshowLightbox showThumbnails lightboxIdentifier="searchImage" images={searchImage} onOpen={() => { document.body.classList.add("overflow-hidden") }} onClose={() => { document.body.classList.remove("overflow-hidden") }} className="grid xxl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4">
                            {searchImage.map((item, key) => (
                                <div key={key}>
                                    <Image src={item.image} data-lightboxjs="searchImage" alt="gallery" className="rounded-t-xl w-full" />
                                    <div className='sm:p-4 p-3 bg-body-color'>
            ...
            {searchVideoModal &&
                <>
                    ...
                    <div onClick={openSearchVideoModal} className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[5px]`}></div>
                </>
            }
        </Layout>
    )
