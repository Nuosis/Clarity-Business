            ...
            <div className='grid grid-cols-12 gap-4'>
                ...
                <div className='flex flex-col gap-4 xxl:col-span-6 lg:col-span-8 col-span-12'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <div className='p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-1'>
                        ...
                        <div className='p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-4'>
                ...
                <div className='flex flex-col gap-4 xxl:col-span-3 col-span-12'>
                    <div className='card rounded-xl bg-card-color overflow-hidden'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <SlideshowLightbox showThumbnails lightboxIdentifier="overviewPhotos" onOpen={() => { document.body.classList.add("overflow-hidden") }} onClose={() => { document.body.classList.remove("overflow-hidden") }} className="grid grid-cols-3 gap-1">
                            {overviewPhotos.map((item, key) => (
                                <Image key={key} src={item} data-lightboxjs="overviewPhotos" alt='gallery' className="rounded-md w-full" />
                            ))}
                        </SlideshowLightbox>
                    </div>
                </div>
