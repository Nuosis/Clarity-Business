    ...
    return (
        <>
            ...
            <div className='grid xxl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4'>
                <div className='card overflow-hidden bg-card-color rounded-xl relative md:p-6 p-4 flex flex-col'>
                    <button className='absolute top-10 right-10 z-[1] bg-primary-10 p-[2px] rounded text-primary transition-all hover:bg-primary hover:text-white'>
                        <IconDots className='w-[18px] h-[18px]' />
                    </button>
                    <div className='py-6 flex gap-2 justify-center flex-wrap'>
                        <Image src={avatar1} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar2} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar3} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar4} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                    </div>
                ...
                <div className='card overflow-hidden bg-card-color rounded-xl relative md:p-6 p-4 flex flex-col'>
                    ...
                    <div className='py-6 flex gap-2 justify-center flex-wrap'>
                        <Image src={avatar5} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar6} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar7} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                    </div>
                    <div className='text-center mt-auto'>
                        <p>
                            Management
                ...
                <div className='card overflow-hidden bg-card-color rounded-xl relative md:p-6 p-4 flex flex-col'>
                    ...
                    <div className='py-6 flex gap-2 justify-center flex-wrap'>
                        <Image src={avatar8} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar9} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar10} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <Image src={avatar1} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                    </div>
                    <div className='text-center mt-auto'>
                        <p>
                ...
                <div className='card overflow-hidden bg-card-color rounded-xl relative md:p-6 p-4 flex flex-col'>
                    ...
                    <div className='py-6 flex gap-2 justify-center flex-wrap'>
                        <Image src={avatar1} alt='user profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary' />
                        <div className='w-[36px] h-[36px] min-w-[36px] rounded-md bg-body-color flex items-center justify-center font-semibold text-secondary'>
                            RH
                        </div>
                    </div>
                    <div className='text-center mt-auto'>
            ...
            <div className={`fixed top-0 bg-card-color z-[5] h-svh w-full max-w-[400px] transition-all duration-200 ${createGroupSidebar ? 'ltr:right-0 rtl:left-0' : 'ltr:-right-full rtl:-left-full'}`}>
                ...
                <div className='p-4 h-[calc(100svh-62px)] overflow-auto no-scrollbar'>
                    ...
                    <div className='flex items-center gap-2 mb-4'>
                        <span>Added : </span>
                        <Image src={avatar1} alt='userProfile' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                        <Image src={avatar2} alt='userProfile' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                        <Image src={avatar3} alt='userProfile' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                    </div>
