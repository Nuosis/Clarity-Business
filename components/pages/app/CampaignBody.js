        ...
        <>
            <div className='grid xxl:grid-cols-[5fr_7fr] grid-cols-1 gap-4 mb-6'>
                ...
                <div className='card bg-card-color rounded-xl'>
                    ...
                    <div className='flex flex-wrap md:gap-6 gap-4 md:p-6 p-4'>
                        <div className='flex flex-wrap md:gap-6 gap-4 flex-1'>
            ...
            <div>
                ...
                <div className='flex flex-col gap-5'>
                    <div className='card rounded-xl bg-card-color md:p-6 p-4 flex gap-4 lg:items-center lg:flex-row flex-col'>
                        ...
                        <div className='grid grid-cols-3 gap-6 w-full lg:max-w-[400px]'>
                            <div>
                                <p className='font-medium'>
                                    3,021
                                </p>
