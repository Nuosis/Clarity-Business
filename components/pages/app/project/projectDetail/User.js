    ...
    return (
        <>
            ...
            <ul className='flex flex-col gap-2'>
                <li className='card rounded-xl bg-card-color md:p-6 p-4 flex items-center gap-4 md:flex-row flex-col'>
                    ...
                    <div className='grid md:grid-cols-[1fr_1.5fr_1fr] grid-cols-1 md:justify-items-start justify-items-center gap-3 items-center w-full'>
                        <div>
                        ...
                        <ul className='grid grid-cols-3 md:gap-4 gap-6 w-full md:text-start text-center md:max-w-full max-w-[350px]'>
                            <li>
