    ...
    return (
        <>
            <div className='flex items-center gap-2 text-[24px]/[30px] font-medium my-2'>
                <button onClick={() => navigate.back()} className='text-primary transition-all hover:text-secondary'>
                    ...
                    <ul className=''>
                        <li className='border-b border-dashed border-border-color px-6 py-3 flex items-center gap-3 transition-all hover:bg-primary-10 last:border-b-0'>
                            ...
                            <div className='flex items-center gap-2 justify-between w-full truncate'>
                                ...
                                <div className="flex">
                                    <Image src={avatar1} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar2} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                </div>
                            </div>
                        </li>
                        <li className='border-b border-dashed border-border-color px-6 py-3 flex items-center gap-3 transition-all hover:bg-primary-10 last:border-b-0'>
                            ...
                            <div className='flex items-center gap-2 justify-between w-full truncate'>
                                ...
                                <div className="flex">
                                    <Image src={avatar1} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar2} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar3} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                </div>
                            </div>
                        </li>
                        <li className='border-b border-dashed border-border-color px-6 py-3 flex items-center gap-3 transition-all hover:bg-primary-10 last:border-b-0'>
                            ...
                            <div className='flex items-center gap-2 justify-between w-full truncate'>
                                ...
                                <div className="flex">
                                    <Image src={avatar4} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar5} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar6} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar7} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                </div>
                            </div>
                        </li>
                        <li className='border-b border-dashed border-border-color px-6 py-3 flex items-center gap-3 transition-all hover:bg-primary-10 last:border-b-0'>
                            ...
                            <div className='flex items-center gap-2 justify-between w-full truncate'>
                                ...
                                <div className="flex">
                                    <Image src={avatar9} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar10} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                </div>
                            </div>
                        </li>
                        <li className='border-b border-dashed border-border-color px-6 py-3 flex items-center gap-3 transition-all hover:bg-primary-10 last:border-b-0'>
                            ...
                            <div className='flex items-center gap-2 justify-between w-full truncate'>
                                ...
                                <div className="flex">
                                    <Image src={avatar5} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                    <Image src={avatar8} alt="Project Team" className="rounded-md w-[26px] h-[26px] min-w-[26px] border-2 border-card-color -ml-3 hover:relative hover:z-[1]" />
                                </div>
                            </div>
                        </li>
                    </ul>
