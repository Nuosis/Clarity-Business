    ...
    return (
        <>
            ...
            <div className='flex flex-wrap gap-4'>
                <div className='card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow'>
                    <div className='md:p-6 p-4 border-b border-dashed border-border-color'>
                        ...
                        <div className='progress overflow-hidden h-[3px] bg-border-color rounded-full mt-2'>
                            <div className='progress-bar w-[0%] bg-danger h-full'></div>
                        </div>
                    </div>
                ...
                <div className='card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow'>
                    <div className='md:p-6 p-4 border-b border-dashed border-border-color'>
                        ...
                        <div className='progress overflow-hidden h-[3px] bg-border-color rounded-full mt-2'>
                            <div className='progress-bar w-[0%] bg-info h-full'></div>
                        </div>
                    </div>
                    <div className='md:p-6 p-4 flex gap-x-3 gap-y-1 flex-wrap'>
                        <div className='flex gap-1 flex-wrap'>
