...
export default function EmailSidebar({ emailSide }) {
    return (
        <div className={`bg-card-color min-w-[210px] w-[210px] p-4 xl:h-[calc(100svh-77px)] md:h-[calc(100svh-73px)] h-[calc(100svh-60px)] overflow-auto no-scrollbar lg:static fixed z-[2] rounded-ss-2xl transition-all duration-300 ${emailSide ? 'md:left-[13px] sm:left-2 left-0 rtl:md:right-[13px] rtl:sm:right-2 rtl:right-0 shadow-shadow-lg' : '-left-full rtl:-right-full'}`}>
