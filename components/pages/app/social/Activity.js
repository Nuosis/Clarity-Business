...
export default function Activity() {
    ...
    return (
        <>
            ...
            <div className='mb-4 md:p-6 p-4 rounded-xl bg-gradient-to-r from-primary to-secondary flex items-start flex-wrap xxl:gap-12 md:gap-6 gap-4'>
                ...
                <div>
                    <p className='text-[20px]/[26px] font-medium mb-1'>
                        Allie Grater
                    </p>
                    <p className='text-[14px]/[20px] mb-2'>
                        UI/UX Designer
                    </p>
                    <div className='flex items-stretch flex-wrap gap-2'>
                        <div className='md:py-2 md:px-4 py-1 px-2 card bg-card-color md:rounded-xl rounded-md flex flex-col'>
            ...
            <div className='grid lg:grid-cols-[8fr_4fr] md:grid-cols-[7fr_5fr] grid-cols-1 gap-4'>
                <div className='flex flex-col gap-4'>
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        <div className='flex items-center justify-between gap-2 md:mb-6 mb-4'>
                            <div className='flex gap-4 items-start'>
                                <Image src={profile_av} alt='profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] object-cover rounded-md' />
                                <div>
                        ...
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-1'>
                        ...
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-4'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-1'>
                            ...
                            <div className='flex-1'>
                                ...
                                <div className='bg-card-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <div className="flex flex-wrap">
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar1} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar2} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar3} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar4} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar5} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar6} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar7} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar8} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar9} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <Image className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar10} title="Avatar Name" alt="User Profile" width="36" height="36" />
                        </div>
                    </div>
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        <div className='flex items-center justify-between gap-2 md:mb-6 mb-4'>
                        ...
                        <ul className='flex flex-col gap-1'>
                            <li className='bg-body-color p-4 flex gap-4 rounded-xl mb-1'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <SlideshowLightbox showThumbnails lightboxIdentifier="latestPhotos" onOpen={()=>{document.body.classList.add("overflow-hidden")}} onClose={()=>{document.body.classList.remove("overflow-hidden")}} className="grid grid-cols-3 gap-1">
                            {latestPhotos.map((item, key) => (
                                <Image key={key} src={item.image} data-lightboxjs="latestPhotos" alt='gallery' className="rounded-md w-full" />
                            ))}
                        </SlideshowLightbox>
                    </div>
                </div>
